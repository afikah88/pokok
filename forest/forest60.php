...
$conn->query("DROP TABLE IF EXISTS tree_data60");
$conn->query("
    CREATE TABLE tree_data60 (
...
$stmt = $conn->prepare("INSERT INTO tree_data60 (block_x, block_y, coord_x, coord_y, treeNum, species_code, species_group, diameter, height, 
