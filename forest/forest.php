...
$conn->query("DROP TABLE IF EXISTS tree_data");
$conn->query("
...
$stmt = $conn->prepare("INSERT INTO tree_data (block_x, block_y, coord_x, coord_y, treeNum, species_code, species_group, diameter, height, 
