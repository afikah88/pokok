...
$conn->query("DROP TABLE IF EXISTS tree_data55");
$conn->query("
    CREATE TABLE tree_data55 (
...
$stmt = $conn->prepare("INSERT INTO tree_data55 (block_x, block_y, coord_x, coord_y, treeNum, species_code, species_group, diameter, height, 
